...
// This button will be used to calculate the age
...
const validateInputs = () => {
  ...
  // I removed the return, and placed the AgeCalc with some parameters.
  ageCalc(isDayValid, isMonthValid, isYearValid);
};

const ageCalc = (dayValid, monthValid, yearValid) => {
  // I change the conditional to use the parameters. It'll only fire calculateDifferences if all the inputs are valid.
...
// When you click button, it will trigger the validateInputs function
